            ...
            <div className="group relative block h-full flex flex-col">
                ...
                <div className="mt-2 flex flex-col gap-1 flex-1">
                    ...
                    <button
                        ...
                        className="mt-auto w-full bg-[var(--color-brand-red)] text-white hover:bg-[var(--color-brand-red)] hover:shadow-[0_0_20px_var(--color-brand-red)] hover:brightness-110 text-xs font-bold font-mono uppercase tracking-widest py-3 px-4 rounded-sm transition-all flex items-center justify-center gap-2"
                    >

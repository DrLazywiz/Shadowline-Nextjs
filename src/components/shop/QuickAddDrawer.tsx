            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed bottom-0 left-0 right-0 md:top-1/2 md:left-1/2 md:right-auto md:bottom-auto md:-translate-x-1/2 md:-translate-y-1/2 md:w-full md:max-w-md z-[90] bg-neutral-900 border-t md:border border-white/10 rounded-t-xl md:rounded-xl p-6 flex flex-col max-h-[85vh]"
                    >
                        {/* Header */}
                        ...
                        <button
                            ...
                            className="w-full bg-white text-black font-bold uppercase tracking-widest py-4 rounded-sm hover:bg-neutral-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >

    ...
    return (
        ...
        >
            <div className="container mx-auto px-6 relative z-20">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-24 text-[10px] font-mono uppercase tracking-widest text-neutral-500">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-wrap gap-6">
                            ...
                            <Link href="/refund-policy" className="hover:text-white transition-colors">Return Policy</Link>
                            <Link href="/terms-and-conditions" className="hover:text-white transition-colors">Terms and Condition</Link>
                        </div>
                    </div>
                ...
                <div className="relative w-full h-[14vw] flex items-center justify-center select-none pointer-events-none">
                    {/* Background Layer (Dim) */}
                    <h1 className="absolute inset-0 flex items-center justify-center text-[12vw] leading-none font-black tracking-tighter text-neutral-900 z-0">
                        SHADOWLINE
                    </h1>

                    {/* Spotlight Layer (Revealed by Mask) */}
                    <motion.h1
                        className="absolute inset-0 flex items-center justify-center text-[12vw] leading-none font-black tracking-tighter text-neutral-800 z-10 bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-500"
                        style={{
                    ...
                    <h1 className="absolute inset-0 flex items-center justify-center text-[12vw] leading-none font-black tracking-tighter text-[var(--color-brand-red)] opacity-5 blur-3xl z-[-1]">
                        SHADOWLINE
                    </h1>
                </div>
            </div>
